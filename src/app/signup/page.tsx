...
const [formError, setFormError] = useState<string | null>(null);  // للأخطاء العامة
const [fieldError, setFieldError] = useState<{ username?: boolean; email?: boolean; password?: boolean; invite?: boolean }>({});  // للأخطاء المحلية  
  ...
  const onRegister = async () => {
    ...
    if (!json.ok) {
      ...
      // نخلي تحديد الحقل حسب نوع الخطأ (لو السيرفر رجع field)
      const f = json.field;
